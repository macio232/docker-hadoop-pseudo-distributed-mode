...
hadoop jar $HADOOP_HOME/share/hadoop/mapreduce/hadoop-mapreduce-examples-3.1.2.jar teragen $NUMBER_OF_100_BYTE_ROWS /user/$USER/benchmarks/terasort-input
TERASORT_START=`date +%s` # %s means seconds since 1970-01-01 00:00:00 UTC
hadoop jar $HADOOP_HOME/share/hadoop/mapreduce/hadoop-mapreduce-examples-3.1.2.jar terasort /user/$USER/benchmarks/terasort-input /user/$USER/benchmarks/terasort-output
TERASORT_END=`date +%s` # %s means seconds since 1970-01-01 00:00:00 UTC
hadoop jar $HADOOP_HOME/share/hadoop/mapreduce/hadoop-mapreduce-examples-3.1.2.jar teravalidate /user/$USER/benchmarks/terasort-output /user/$USER/benchmarks/terasort-validate
